...
class Cart(object):
    """
    Класс карзины для управления заказами
    """
    ...
    def add(self, product, quantity=1, update_quantity=False):
        """
        Добавить продукт в карзину или обновить его количество

        product : Экземпляр Flight для добавления или обновления в корзине
    ...
    def __iter__(self):
        ...
        # Генератор общей стоимости товаров
